...
/**
 * Contract information including the party's role and associated product
 */
@Data
...
public class ContractInfoDTO {
     ...
     */
    @JsonProperty("contractPartyId")
    private UUID contractPartyId;

    @JsonProperty("roleInContract")
    private RoleInfoDTO roleInContract;

    /**
     * Product linked to this contract
     */
